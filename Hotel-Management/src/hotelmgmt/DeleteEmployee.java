...
public class DeleteEmployee extends javax.swing.JFrame {
     ...
     */
    public DeleteEmployee(HotelSystem hs) {
        ht = hs;
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(employeeId, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        try{
            if(UserControls.integerCheck(employeeId.getText())){
                if(ht.deleteEmployeeManual(Integer.valueOf(employeeId.getText()))){
                    UserView.speakInfo("Employee deletion successful.");
                    UserView.listClear();
                    this.dispose();
                }
            }
            else{
                UserView.speakInfo("Error occurred.  Employee not deleted.");
                this.dispose();
            }            
        }
        catch(Exception e){
